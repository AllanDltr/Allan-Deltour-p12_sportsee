...
const WeeklyCharts = (userId) => {
    ...
    return (<div className="daily__activity">
            <ResponsiveContainer width="100%" height="100%" className="daily__activity__fond">
